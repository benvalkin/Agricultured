...
public class AgriCropBlock extends net.minecraft.world.level.block.CropBlock {
    ...
    private AgriSeedItem seed;


    public AgriCropBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
...
//    }
    ...
    public void setSeed(AgriSeedItem agriSeedItem) {
        this.seed = agriSeedItem;
    }
}
